...
cat <<EOF >module.tf
module "helm_deploy" {
  source                 = "git::https://github.com/mybestsea/helm-deploy.git"
  deployment_name        = "example-deployment"
  deployment_environment = "dev"
  deployment_endpoint    = "example.mybestsea.com"
...
| `deployment_endpoint` | Ingress endpoint `example.mybestsea.com` | `(Required)` | `domain/string` |
...
module "helm_deploy" {
  ...
  deployment_environment = "dev"
  deployment_endpoint    = "artemis.mybestsea.com"
...
```
╭─ fsadykov ~/Projects/mybestsea-projects/terraform-modules/deploy-testing
...
```
╭─ fsadykov ~/Projects/mybestsea-projects/helm-deploy
...
Created for mybestsea developed by mybestsea DevOps team enjoy using it
